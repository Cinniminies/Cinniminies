...
// Menú del catálogo + costos y márgenes vigentes (salen de las vistas de la base).
export async function mostrar(cont) {
  ...
  vaciar(cont,
    h('ul', { class: 'lista menu-mas' },
      item('#/sabores', 'Sabores', 'Recetas, activar u ocultar en la web, precio por unidad'),
      item('#/insumos', 'Insumos', 'Ingredientes y packaging, mínimos, lo que lleva cada caja'),
      item('#/formatos', 'Formatos', 'Cajas, personalizado y unidad, con su precio'),
      item('#/precios', 'Precios', 'Todos los precios vigentes y programados')),

    h('h2', {}, 'Costo por sabor'),
